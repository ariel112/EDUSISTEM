   ...
   <!-- page content -->
        <div class="right_col" role="main">         
            ...
            <div class="row">
 			 ...
 			 <?php echo Form::open(['route' => ['becas.store'], 'method'=>'POST', 'files'=>true,'data-parsley-validate','class'=>'form-horizontal form-label-left']); ?>

 			 			 <input type="text" name="users_id" style="display: none;" value="<?php echo e(Auth::user()->id); ?>">		                 
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              ...
                              <textarea required="required" name="descripcion" class="form-control col-md-7 col-xs-12"></textarea>
                            </div>
                          </div>               
