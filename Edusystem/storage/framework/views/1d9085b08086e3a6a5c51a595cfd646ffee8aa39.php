              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <li><a><i class="fa fa-refresh"></i> Nombre complementaria <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                          <li><a href="<?php echo e(route('Cnombre.create')); ?>"><i class="fa fa-search"></i>Buscar becarios</a></li>
                          <li><a href="<?php echo e(route('Cnombre.index')); ?>"><i class="fa fa-search"></i>Buscar becarios</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a><i class="fa fa-list-alt"></i>Plan. Complementarias<span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                          ...
                          <li><a href="<?php echo e(route('complementaria.index')); ?>"><i class="fa fa-search"></i> Complementarias</a></li>
                        </ul>
                    </li>  
