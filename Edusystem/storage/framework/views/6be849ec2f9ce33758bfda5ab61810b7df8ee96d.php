                    ...
                    <div class="col-xs-9">
                      ...
                      <div class="tab-content">
                        <div class="tab-pane active" id="home">
                          ...
                          <h3 class="mt-2 color-negro"><i class="fa fa-credit-card"></i> Identidad: <?php echo e($becario->identidad); ?></h3>
                          <h3 class="mt-2 color-negro"><i class="fa fa-tablet"></i> Celular:  <?php echo e($becario->celular); ?></h3> 
...
<?php echo Form::open(['route' => ['documentos.store'], 'method'=>'POST', 'files'=>true,'data-parsley-validate','class'=>'form-horizontal form-label-left']); ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <input type="text" name="identidad" style="display: none;" value="<?php echo e($becario->identidad); ?>" class="form-control" style="width: 60px;">
...
<?php echo Form::open(['route' => ['ficha.store'], 'method'=>'POST', 'files'=>true,'data-parsley-validate','class'=>'form-horizontal form-label-left']); ?>
