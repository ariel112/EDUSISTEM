                      ...
                      <tbody>
                         <?php $__currentLoopData = $datos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="center">
                                        <a href="<?php echo e(route('aspirantes.perfil', $dato->id)); ?>">
                                    ...
                                    <td class="alinear">
                                        <a href="<?php echo e(route('aspirantes.edit',$dato->id)); ?>">
                                            <img class="center-imagen" width="50" height="50" src="<?php echo e(asset('images/editar.png')); ?>">
                                        </a>
                                    </td>
