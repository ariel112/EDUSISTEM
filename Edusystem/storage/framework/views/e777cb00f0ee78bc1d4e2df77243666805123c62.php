...
<div class="right_col" role="main">
 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Busqueda Global de becarios en el sistema (Actualizacion de documentos)</h2>
                      ...
                      <tbody>
                         <?php $__currentLoopData = $datos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="center">
                                        <a href="<?php echo e(route('actualizacion.perfil', $dato->id)); ?>">
                                    ...
                                    <td><?php echo e($dato->celular); ?></td>                                    
                                    <td class="alinear"><img class="center-imagen" width="50" height="50" src="<?php echo e(asset('images/editar.png')); ?>"></td>
